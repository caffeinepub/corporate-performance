...
const navItems = [
  { label: "Company Setup", path: "/admin/company-setup", icon: Building2 },
  {
  ...
  { label: "Role Assignment", path: "/admin/role-assignment", icon: UserCheck },
  { label: "Users", path: "/admin/users", icon: Users },
  {
    label: "KPI & OKR Years",
    path: "/admin/kpi-okr-years",
    icon: CalendarRange,
  },
  { label: "BSC Aspects", path: "/admin/bsc-aspects", icon: PieChart },
  {
    label: "Strategic Objectives",
    path: "/admin/strategic-objectives",
    icon: Target,
  },
  { label: "KPI View", path: "/admin/kpi-view", icon: BarChart2 },
  { label: "OKR View", path: "/admin/okr-view", icon: FileSpreadsheet },
];
